...
Model::Model():
    ...
    _layer1(512,32, DenseLayer::activationType::relu, &bias1, &weight1, 16384, 128, 9),
    _layer2(32,32, DenseLayer::activationType::relu, &bias2, &weight2, 2048, 64, 6),
    _layer3(32, 1, DenseLayer::activationType::linear, &bias3, &weight3, 2048, 64, 0)
{
...
accumulatorType Model::forwardPass(const FeatureList& l, const FeatureList& h) {
    ...
    return _layer3.propagate(_layer2.output(), 0, 0) * 4.8828;
}
