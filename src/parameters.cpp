...
staticNullMovePruningValue(373),
staticNullMovePruningImprovingBonus(2031),

nullMovePruningDepth(16),
nullMovePruningReduction(49),
nullMovePruningBonusDepth(0.25),
nullMovePruningBonusThreshold(10060),
