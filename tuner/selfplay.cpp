...
SelfPlay::SelfPlay(Player& white, Player& black, Book& b, FenSaver * const fs) : _p(Position::pawnHash::off), _c(TunerParameters::gameTime, TunerParameters::gameTimeIncrement), _white(white), _black(black), _book(b), _fs(fs) {
